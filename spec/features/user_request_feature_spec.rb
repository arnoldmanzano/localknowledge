...
feature 'Making a request for a tour', js:true do
  ...
  xcontext '===> accessing the form ' do
    ...
    context '===> when logged in' do
      ...
      it '-> has a \'Request a tour link that opens a form on the REQUESTS page' do
        visit('/requests')
        click_link 'Request a tour'
        expect(page).to have_content('Request a tour from a local')
      end

      it '-> has a \'Request a tour link that opens a form on the EDIT PROFILE page' do
        visit('/users/edit')
        click_link 'Request a tour'
        expect(page).to have_content('Request a tour from a local')
      end
  ...
  xcontext '===> on form submission' do
